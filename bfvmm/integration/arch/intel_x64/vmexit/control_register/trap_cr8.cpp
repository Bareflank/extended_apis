...
public:
        ...
        eapis::intel_x64::vcpu{id}
    {
        ...
        this->add_rdcr8_handler(
            control_register_handler::handler_delegate_t::create<vcpu, &vcpu::test_rdcr8_handler>(this)
        );

        this->add_wrcr8_handler(
            control_register_handler::handler_delegate_t::create<vcpu, &vcpu::test_wrcr8_handler>(this)
        );

...
// TODO: The fault recording register intrinsics are hard-coded to assume that
// only one registers exists at a fixed offset in the iommu. These need to be
// updated to calculate the offset and number of fault recording registers
// to work generarically with any Intel chipset.
namespace frr
{

...
TEST_CASE("phys_xapic: read_register")
{
    ...
    auto off = lapic_n::offset::from_mem_addr(id_addr);
...
TEST_CASE("phys_xapic: write_register")
{
    ...
    auto off = lapic_n::offset::from_mem_addr(icr0_addr);
...
TEST_CASE("phys_xapic::read_version")
{
    ...
    auto off = lapic_n::offset::from_mem_addr(ver_addr);
...
TEST_CASE("phys_xapic::read_svr")
{
    ...
    auto off = lapic_n::offset::from_mem_addr(svr_addr);
...
TEST_CASE("phys_xapic::read_icr")
{
    ...
    auto off0 = lapic_n::offset::from_mem_addr(icr0);
    auto off1 = lapic_n::offset::from_mem_addr(icr1);
...
TEST_CASE("phys_xapic::write_eoi")
{
    ...
    auto off = lapic_n::offset::from_mem_addr(eoi_addr);

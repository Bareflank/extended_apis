...
void
ehlr_eapis::register_json_vmcall__wrmsr()
{
...
void
ehlr_eapis::handle_vmcall__wrmsr(
...
void
ehlr_eapis::handle_vmcall__trap_on_wrmsr_access(
    msr_type msr)
{
...
void
ehlr_eapis::handle_vmcall__trap_on_all_wrmsr_accesses()
{
...
void
ehlr_eapis::handle_vmcall__pass_through_wrmsr_access(
    msr_type msr)
{
...
void
ehlr_eapis::handle_vmcall__pass_through_all_wrmsr_accesses()
{
...
void
ehlr_eapis::handle_vmcall__whitelist_wrmsr_access(
    msr_list_type msrs)
{
...
void
ehlr_eapis::handle_vmcall__blacklist_wrmsr_access(
    msr_list_type msrs)
{
...
void
ehlr_eapis::handle_vmcall__log_wrmsr_access(
    bool enabled)
{
...
void
ehlr_eapis::handle_vmcall__clear_wrmsr_access_log()
{
...
void
ehlr_eapis::handle_vmcall__wrmsr_access_log(
    json &ojson)
{

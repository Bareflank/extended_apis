...
void
ehlr_eapis::register_json_vmcall__io_instruction()
{
...
void
ehlr_eapis::handle_vmcall__io_instruction(
...
void
ehlr_eapis::handle_vmcall__enable_io_bitmaps(
    bool enabled)
{
...
void
ehlr_eapis::handle_vmcall__trap_on_io_access(
    port_type port)
{
...
void
ehlr_eapis::handle_vmcall__trap_on_all_io_accesses()
{
...
void
ehlr_eapis::handle_vmcall__pass_through_io_access(
    port_type port)
{
...
void
ehlr_eapis::handle_vmcall__pass_through_all_io_accesses()
{
...
void
ehlr_eapis::handle_vmcall__whitelist_io_access(
...
void
ehlr_eapis::handle_vmcall__blacklist_io_access(
    const port_list_type &ports)
{
...
void
ehlr_eapis::handle_vmcall__log_io_access(
    bool enabled)
{
...
void
ehlr_eapis::handle_vmcall__clear_io_access_log()
{
...
void
ehlr_eapis::handle_vmcall__io_access_log(json &ojson)
{
